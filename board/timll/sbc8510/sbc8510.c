 ...
 *
 * Derived from SBC8510 Board and 3430 SDP code by
...
int board_init(void)
{
	...
	/* board id for Linux */
	gd->bd->bi_arch_number = MACH_TYPE_OMAP3_SBC8510;
	/* boot param addr */
...
/*
 * Routine: sbc8510_get_revision
 * Description: Return the revision of the SBC8510Board this code is running on.
 */
int sbc8510_get_revision(void)
{
	return sbc8510_revision;
}

/*
 * Routine: sbc8510_identify
...
void sbc8510_identify(void)
{
	...
	sbc8510_revision = omap_get_gpio_datain(173) << 2 |
