 ...
 *
 * Derived from SBC8100_PLUS Board and 3430 SDP code by
...
#include "sbc8100_plus.h"
#include <netdev.h>
#include <asm/arch/mem.h>

#include "devkit_logo_FNL_2.h"

static int sbc8100_plus_revision;
...
int board_init(void)
{
	...
	/* board id for Linux */
	gd->bd->bi_arch_number = MACH_TYPE_OMAP3_SBC8100_PLUS;
	/* boot param addr */
...
/*
 * Routine: sbc8100_plus_get_revision
 * Description: Return the revision of the SBC8100_PLUS Board this code is running on.
 */
int sbc8100_plus_get_revision(void)
{
	return sbc8100_plus_revision;
}

/*
 * Routine: sbc8100_plus_identify
 * Description: Detect if we are running on a SBC8100_PLUS revision Ax/Bx,
 ...
 */
void sbc8100_plus_identify(void)
{
#if 0
	...
	sbc8100_plus_revision = omap_get_gpio_datain(173) << 2 |
	...
	omap_free_gpio(173);
#else
	sbc8100_plus_revision = REVISION_XM;
#endif
}
...
int misc_init_r(void)
{
	...
	sbc8100_plus_identify();

	twl4030_power_init();
	twl4030_led_init(TWL4030_LED_LEDEN_LEDAON | TWL4030_LED_LEDEN_LEDBON);

	switch (sbc8100_plus_revision) {
	case REVISION_AXBX:
		printf("SBC8100_PLUS Rev Ax/Bx\n");
		setenv("mpurate", "600");
		break;
	case REVISION_CX:
		printf("SBC8100_PLUS Rev C1/C2/C3\n");
		MUX_SBC8100_PLUS_C();
		setenv("mpurate", "600");
		break;
	case REVISION_C4:
		printf("SBC8100_PLUS Rev C4\n");
		MUX_SBC8100_PLUS_C();
...
//		MUX_SBC8100_PLUS_XM();
		...
		break;
	default:
		printf("SBC8100_PLUS unknown 0x%02x\n", sbc8100_plus_revision);
	}
