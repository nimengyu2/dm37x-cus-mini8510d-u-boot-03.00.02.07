 ...
 * MA 02111-1307 USA
 */
#ifndef _SBC8100_PLUS_H_
#define _SBC8100_PLUS_H_

const omap3_sysinfo sysinfo = {
	DDR_STACKED,
	"OMAP3 SBC8100_PLUS board",
...
#define MUX_SBC8100_PLUS() \
 ...
 /*GPMC*/\
	...
	MUX_VAL(CP(GPMC_A7),		(IDIS | PTD | DIS | M4)) /*GPMC_A7*/\
	MUX_VAL(CP(GPMC_A8),		(IDIS | PTD | DIS | M4)) /*GPMC_A8*/\
	...
	MUX_VAL(CP(GPMC_NCS7),		(IEN  | PTU | EN  | M0)) /*SYS_nDMA_REQ3*/\
 ...
 /* USB EHCI (port 2) */\
	...
	MUX_VAL(CP(ETK_D11_ES2),        (IEN  | PTU | EN  | M4)) /*GPIO_25 for ENT_INT*/\
