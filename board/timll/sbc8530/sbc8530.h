...
#define MUX_SBC8530() \
 ...
 /*GPMC*/\
	MUX_VAL(CP(GPMC_A1),		(IDIS | PTD | EN  | M4)) /*GPIO_34*/\
	MUX_VAL(CP(GPMC_A2),		(IDIS | PTD | DIS | M0)) /*GPMC_A2*/\
	MUX_VAL(CP(GPMC_A3),		(IDIS | PTD | DIS | M0)) /*GPMC_A3*/\
	MUX_VAL(CP(GPMC_A4),		(IDIS | PTD | DIS | M0)) /*GPMC_A4*/\
	MUX_VAL(CP(GPMC_A5),		(IDIS | PTD | DIS | M0)) /*GPMC_A5*/\
	MUX_VAL(CP(GPMC_A6),		(IDIS | PTD | DIS | M4)) /*GPIO_39*/\
	MUX_VAL(CP(GPMC_A7),		(IDIS | PTD | EN  | M4)) /*GPIO_40*/\
 ...
 /*CAMERA*/\
	...
	MUX_VAL(CP(CAM_STROBE),		(IDIS | PTD | DIS | M4)) /*GPIO_126*/\
 ...
 /*Wireless LAN */\
        ...
        MUX_VAL(CP(MMC2_DAT7),          (IDIS | PTD | DIS | M0)) /*MMC2_DAT7*/\
 /*Bluetooth*/\
 ...
 /*Serial Interface*/\
	MUX_VAL(CP(UART3_CTS_RCTX),	(IDIS | PTD | DIS | M4)) /*UART3_CTS_RCTX*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(SYS_CLKOUT2),	(IDIS | PTU | EN  | M4)) /*GPIO_186*/\
        ...
        MUX_VAL(CP(ETK_D1_ES2 ),    	(IDIS | PTU | DIS | M4)) /*GPIO_15*/\
        MUX_VAL(CP(ETK_D2_ES2 ),    	(IDIS | PTU | DIS | M4)) /*GPIO_16*/\
        MUX_VAL(CP(ETK_D3_ES2 ),    	(IDIS | PTU | DIS | M4)) /*GPIO_17*/\
        ...
        MUX_VAL(CP(ETK_D8_ES2 ),    	(IEN  | PTU | DIS | M4)) /*GPIO_22*/\
