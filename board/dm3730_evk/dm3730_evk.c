 ...
 *
 * Derived from DM3730_EVK Board and 3430 SDP code by
...
#include "dm3730_evk.h"
#include <netdev.h>
#include <asm/arch/mem.h>

#include "devkit_logo_FNL_2.h"

static int dm3730_evk_revision;
...
int board_init(void)
{
	...
	/* board id for Linux */
	gd->bd->bi_arch_number = MACH_TYPE_DM3730_EVK;
	/* boot param addr */
...
/*
 * Routine: dm3730_evk_get_revision
 * Description: Return the revision of the DM3730_EVK Board this code is running on.
 */
int dm3730_evk_get_revision(void)
{
	return dm3730_evk_revision;
}

/*
 * Routine: dm3730_evk_identify
...
void dm3730_evk_identify(void)
{
	...
	dm3730_evk_revision = omap_get_gpio_datain(173) << 2 |
	...
	omap_free_gpio(173);
#else
	dm3730_evk_revision = REVISION_XM;
#endif
}
