...
dm3730_evk_config :   unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 dm3730_evk NULL omap3

omap3_sbc8510_config :   unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 sbc8510 timll omap3

omap3_sbc8100_plus_config :   unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 sbc8100_plus timll omap3

omap3_sbc8150_config :   unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 sbc8150 timll omap3

omap3_sbc8530_config :   unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 sbc8530 timll omap3

omap3_soc8600_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm arm_cortexa8 soc8600 timll omap3
